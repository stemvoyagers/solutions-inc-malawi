                ...
                <div className="relative max-w-screen-xl mx-auto mt-4 md:mt-0 px-4 md:px-8 lg:px-12 xl:px-16 flex flex-col justify-center items-center gap-y-10 text-center z-10">
                    ...
                    <div className="flex flex-col w-96 md:w-full md:grid md:grid-cols-6 gap-4 justify-items-center">
                        <div className="col-span-2 border rounded-lg p-6 overflow-hidden bg-blue-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <p className="text-base">{services[0].description}</p>
                        </div>
                        <div className="col-span-2 border rounded-lg p-6 overflow-hidden bg-blue-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                            <h3 className="text-2xl font-bold mb-2">{services[1].title}</h3>
                            <p className="text-base">{services[1].description}</p>
                        </div>
                        <div className="col-span-2 border rounded-lg p-6 overflow-hidden bg-blue-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                            <h3 className="text-2xl font-bold mb-2">{services[2].title}</h3>
                            <p className="text-base">{services[2].description}</p>
                        </div>
                        <div className="col-span-2 col-start-2 border rounded-lg p-6 overflow-hidden bg-blue-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                            <h3 className="text-2xl font-bold mb-2">{services[3].title}</h3>
                            <p className="text-base">{services[3].description}</p>
                        </div>
                        <div className="col-span-2 border rounded-lg p-6 overflow-hidden bg-blue-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
                            <h3 className="text-2xl font-bold mb-2">{services[4].title}</h3>
                            <p className="text-base">{services[4].description}</p>
                        </div>
                    </div>
                </div>
            </>
