...
const CareerBody = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-1 gap-16 md:gap-28 z-50">
        <div className="w-full flex flex-col justify items-center pl-4 md:pl-0 pr-4 md:pr-0 gap-8 md:gap-0 transform animate-slide-up">
          <div className="md:mt-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-5 text-center">
            <div className="w-[100%] md:p-4 text-2xl font-semibold">
              WHAT WE DO
            </div>
            <div className="w-[100%] md:w-[70%] md:p-4 text-sm md:text-xl text-justify md:text-left">
          ...
          <div className="md:mt-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-5 text-center">
            ...
            top companies like NEC, Veridos, Microsoft, and Oracle to deliver world-class solutions, helping clients 
