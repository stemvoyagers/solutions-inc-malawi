...
const CTACareer = () => {
    return (
        ...
        >
            ...
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-x-20 mt-10 mb- z-10 justify-between items-center">
                <div className="group text-white gap-10 z-10">
                    <h2 className="font-semibold text-[150%] md:text-[300%] md:mb-2 text-white ">
                        Career <br />
                        <p  className="text-sm md:text-xl">We Love Talents Are Welcome To Join The Train</p> 
                    </h2> <br /> <br />
                ...
                <div className="group z-10">
                    <img className="h-52 md:h-96 w-full" src={face} alt="img1" />
                </div>
            </div>
        </div>
    );
